define([
    ...
    'dojo/i18n!./Compensator/nls/resource',
    'dojo/_base/lang',
    'dojo/text!./Compensator/templates/Compensator.html',
    "esri/tasks/query",
    ...
    'xstyle/css!./Compensator/css/Compensator.css'
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        showCount:function(count){
            ...
            this.countResultTitle.innerHTML = "共有" + count + "个补偿器";
        },
        //根据名称或编号查询换热站
        ...
        processResults: function (results) {
            ...
            if (results.features.length == 0) {
                ...
                this.pointSymbol = new PictureMarkerSymbol(require.toUrl('gis/dijit/Compensator/images/search-pointer.png'), 30, 30);
